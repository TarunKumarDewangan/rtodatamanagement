...
const getStatusBadge = (documents, dateField) => {
    const style = { fontSize: '0.7rem', padding: '4px 0', whiteSpace: 'nowrap' }; // Prevent text wrap
                    ...
                    {citizen.vehicles.map(v => (
                        <Card key={v.id} className="shadow-sm border-0 overflow-hidden">
                            <Row className="g-0">
                                ...
                                {/* SECTION A: Registration Header/Sidebar
                                ...
                                */}
                                ...
                                {/* SECTION C: Documents Grid
                                    - Uses CSS Grid to auto-fit
                                    - Mobile: 2-3 per row
                                    - Desktop: 7 per row
                                */}
                                <Col xs={12} lg={8} className="p-3">
                                    <div style={{
                                        display: 'grid',
                                        gridTemplateColumns: 'repeat(auto-fit, minmax(90px, 1fr))', // The magic responsiveness
                                        gap: '10px'
                                    }}>
